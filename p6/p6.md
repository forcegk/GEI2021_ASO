...
# - strace: ya instalado pero queda marcado como instalado manualmente.
apt upgrade -y gcc make perl mate-desktop-environment-core strace
...
## Utilización de *truss* para analizar el comportamiento de *ps*
Montamos una carpeta compartida en virtualbox para visualizar los logs
con mayor comodidad en la máquina host.
