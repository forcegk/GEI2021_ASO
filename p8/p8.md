...
main() {
    ...
    xargs -L1 sh -c "tar -cf - -C \$1/.. \`basename \$1\` | gzip -c$BACKUP_COMPRESSION_LEVEL > $BACKUP_DIR/\$0.tar.gz && chown \$0 $BACKUP_DIR/\$0.tar.gz && chmod 400 $BACKUP_DIR/\$0.tar.gz && echo \"Backed up user \$0 at $BACKUP_DIR/\$0.tar.gz\""
}
